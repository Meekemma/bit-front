    ...
    <div className="container mx-auto px-4 my-8">
      ...
      <div className="my-12">
        ...
        <div className="flex justify-center gap-8 items-center flex-wrap">
          <img src={binance} alt="Binance" className="w-[180px] h-auto" />
          <img src={coingecko} alt="Coingecko" className="w-[180px] h-auto" />
          <img src={coinpayments} alt="CoinPayments" className="w-[180px] h-auto" />
